...
//Замыкания - комбинация функции и ее окружения.
//проще - внутренняя функция "помнит" переменные
//внешней функции даже после того,
//как внешняя завершила свою работу.
...
console.log("-----Смовызывающаяся функция------");
